...
var DndProvider = (0, import_react.memo)(function DndProvider2(_param) {
  var {
    children
  } = _param, props = _objectWithoutProperties(_param, ["children"]);
...
function useCollector(monitor, collect, onUpdate) {
  const [collected, setCollected] = (0, import_react.useState)(() => collect(monitor));
...
function useConnectDragSource(connector) {
  return (0, import_react.useMemo)(() => connector.hooks.dragSource(), [connector]);
}
function useConnectDragPreview(connector) {
  return (0, import_react.useMemo)(() => connector.hooks.dragPreview(), [connector]);
}
...
function useDragDropManager() {
  const {
    dragDropManager
  } = (0, import_react.useContext)(DndContext);
  invariant(dragDropManager != null, "Expected drag drop context");
  return dragDropManager;
}
function useDragSourceConnector(dragSourceOptions, dragPreviewOptions) {
  const manager = useDragDropManager();
  const connector = (0, import_react.useMemo)(() => new SourceConnector(manager.getBackend()), [manager]);
...
function useDragSourceMonitor() {
  const manager = useDragDropManager();
  return (0, import_react.useMemo)(() => new DragSourceMonitorImpl(manager), [manager]);
}
...
function useDragSource(spec, monitor, connector) {
  const handler = (0, import_react.useMemo)(() => new DragSourceImpl(spec, monitor, connector), [monitor, connector]);
  (0, import_react.useEffect)(() => {
    handler.spec = spec;
  }, [spec]);
  return handler;
...
function useDragLayer(collect) {
  ...
  (0, import_react.useEffect)(() => monitor.subscribeToOffsetChange(updateCollected));
  (0, import_react.useEffect)(() => monitor.subscribeToStateChange(updateCollected));
  return collected;
}
function useConnectDropTarget(connector) {
  return (0, import_react.useMemo)(() => connector.hooks.dropTarget(), [connector]);
}
function useDropTargetConnector(options) {
  const manager = useDragDropManager();
  const connector = (0, import_react.useMemo)(() => new TargetConnector(manager.getBackend()), [manager]);
  useIsomorphicLayoutEffect(() => {
...
function useDropTargetMonitor() {
  const manager = useDragDropManager();
  return (0, import_react.useMemo)(() => new DropTargetMonitorImpl(manager), [manager]);
}
...
function useDropTarget(spec, monitor) {
  const dropTarget = (0, import_react.useMemo)(() => new DropTargetImpl(spec, monitor), [monitor]);
  (0, import_react.useEffect)(() => {
  ...
  */
  ...
  constructor(manager, context, options) {
    ...
    this.handleTopMove = (e1) => {
      ...
      const orderedDragOverTargetIds = elementsAtPointExtended.filter((node) => dragOverTargetNodes.indexOf(node) > -1).map((node) => this._getDropTargetId(node)).filter((node) => !!node).filter((id, index, ids) => ids.indexOf(id) === index);
...
var chessboardDefaultProps = {
  ...
  customDndBackend: void 0,
  customDndBackendOptions: void 0,
...
var getRelativeCoords = (boardOrientation, boardWidth, square) => {
...
var isDifferentFromStart = (newPosition) => {
...
var getPositionDifferences = (currentPosition, newPosition) => {
  const difference = {
    removed: {},
    added: {}
  };
...
var defaultPieces = {
  wP: (0, import_jsx_runtime.jsx)("svg", {
  ...
  wR: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  wN: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  wB: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  wQ: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  wK: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  bP: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  bR: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  bN: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  bB: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  bQ: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
  ...
  bK: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    width: "45",
    height: "45",
...
var ChessboardContext = import_react.default.createContext();
var useChessboard = () => (0, import_react.useContext)(ChessboardContext);
var ChessboardProvider = (0, import_react.forwardRef)(({
  animationDuration,
  areArrowsAllowed,
  arePiecesDraggable,
  arePremovesAllowed,
  ...
  const [chessPieces, setChessPieces] = (0, import_react.useState)({
    ...defaultPieces,
    ...customPieces
  });
  const [manualDrop, setManualDrop] = (0, import_react.useState)(false);
  const [previousTimeout, setPreviousTimeout] = (0, import_react.useState)(void 0);
  const [waitingForAnimation, setWaitingForAnimation] = (0, import_react.useState)(false);
  ...
  (0, import_react.useEffect)(() => {
    ...
    const newPieceColour = ((_Object$keys = Object.keys(differences.added)) === null || _Object$keys === void 0 ? void 0 : _Object$keys.length) <= 2 ? (_Object$entries = Object.entries(differences.added)) === null || _Object$entries === void 0 ? void 0 : (_Object$entries$ = _Object$entries[0]) === null || _Object$entries$ === void 0 ? void 0 : _Object$entries$[1][0] : void 0;
  ...
  function clearPremoves(clearLastPieceColour = true) {
    if (clearLastPieceColour) setLastPieceColour(void 0);
    premovesRef.current = [];
    setPremoves([]);
  }
...
var alphaStyle = (width) => ({
  alignSelf: "flex-end",
  paddingLeft: width / 8 - width / 48,
  fontSize: width / 48
});
var numericStyle = (width) => ({
...
function Piece({
  ...
  (0, import_react.useEffect)(() => {
    ...
    const removedPiece = (_positionDifferences$ = positionDifferences.removed) === null || _positionDifferences$ === void 0 ? void 0 : _positionDifferences$[square];
    if (!positionDifferences.added) return;
    const newSquare = Object.entries(positionDifferences.added).find(([s, p]) => p === removedPiece || (removedPiece === null || removedPiece === void 0 ? void 0 : removedPiece[1]) === "P" && (s[1] === "1" || s[1] === "8"));
  ...
  function getSingleSquareCoordinates(square2) {
    return {
      sourceSq: squares[square2]
    };
  }
...
function Square({
  ...
  const squareRef = (0, import_react.useRef)();
  const {
    boardWidth,
    boardOrientation,
    clearArrows,
...
var borderRadius = (customBoardStyle, square, boardOrientation) => {
...
var errorImage = {
  whiteKing: (0, import_jsx_runtime.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    version: "1.1",
    style: {
...
function ErrorBoundary({
  ...
  try {
    ...
    return (0, import_jsx_runtime.jsx)(WhiteKing, {
      showError: true
    });
  }
}
function WhiteKing({
  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    }), showError && (0, import_jsx_runtime.jsx)("h1", {
...
function Board() {
  const boardRef = (0, import_react.useRef)();
  ...
  return boardWidth ? (0, import_jsx_runtime.jsxs)("div", {
    ref: boardRef,
    style: {
      position: "relative"
    },
    children: [(0, import_jsx_runtime.jsx)(Squares, {
      children: ({
        square,
        squareColor,
        col,
        ...
        return (0, import_jsx_runtime.jsxs)(Square, {
          square,
          squareColor,
          setSquares,
          squareHasPremove,
          children: [currentPosition[square] && (0, import_jsx_runtime.jsx)(Piece, {
            piece: currentPosition[square],
            square,
            squares
          }), squareHasPremoveTarget && (0, import_jsx_runtime.jsx)(Piece, {
            isPremovedPiece: true,
            piece: squareHasPremoveTarget.piece,
            square,
            squares
          }), showBoardNotation && (0, import_jsx_runtime.jsx)(Notation, {
            row,
            col
          })]
        }, `${col}${row}`);
      ...
      children: arrows.map((arrow) => {
        ...
        return (0, import_jsx_runtime.jsxs)(import_react.Fragment, {
          children: [(0, import_jsx_runtime.jsx)("defs", {
            children: (0, import_jsx_runtime.jsx)("marker", {
              id: "arrowhead",
              markerWidth: "2",
              markerHeight: "2.5",
              refX: "1.25",
  ...
  }) : (0, import_jsx_runtime.jsx)(WhiteKing, {});
}
function CustomDragLayer() {
  ...
  const getItemStyle = (0, import_react.useCallback)((clientOffset2, sourceClientOffset2) => {
    if (!clientOffset2 || !sourceClientOffset2) return {
      display: "none"
    };
    let {
      x,
      y
    } = snapToCursor ? clientOffset2 : sourceClientOffset2;
    if (snapToCursor) {
  ...
  return isDragging && item.id === id ? (0, import_jsx_runtime.jsx)("div", {
    style: layerStyles,
    children: (0, import_jsx_runtime.jsx)("div", {
...
var Chessboard = (0, import_react.forwardRef)((props, ref) => {
  ...
  return backendSet && clientWindow && (0, import_jsx_runtime.jsx)(ErrorBoundary, {
    children: (0, import_jsx_runtime.jsx)(DndProvider, {
      backend,
      context: clientWindow,
      children: (0, import_jsx_runtime.jsxs)(ChessboardProvider, {
        ref,
        ...otherProps,
        children: [(0, import_jsx_runtime.jsx)(CustomDragLayer, {}), (0, import_jsx_runtime.jsx)(Board, {})]
      })
    })
  });
});
